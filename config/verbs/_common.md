...
answer — your reply competes for a glance, not a reading, and it lands in a
scrollback they may not read for an hour, so it has to make sense read cold.
Lead with the thing that changes what they do next.
